...
// Переключатель между корзинами ресторанов
function renderCartSwitcher() {
    ...
    for (const restaurant in carts) {
        ...
        btn.className = restaurant === getSelectedRestaurant() ? "active btn btn-danger me-2" : "btn btn-outline-danger me-2";
        btn.onclick = () => {
    ...
    if (Object.keys(carts).length === 0) {
        container.textContent = "У вас нет полных корзин.";
    }
}
